  ...
  <div class="min-h-screen flex flex-col">
    ...
    <nav class="bg-black text-white p-4">
      <div class="container mx-auto flex justify-between items-center">
        <a class="text-lg font-bold text-green-500 hover:text-green-300" href="#">
          FitNow
        </a>
        <div>
          <router-link to="/home" class="px-4  text-green-600 hover:text-green-800">Home</router-link>
          <router-link to="" class="px-4 hover:text-geen-300">Logout</router-link>
        </div>
      </div>
    </nav>
